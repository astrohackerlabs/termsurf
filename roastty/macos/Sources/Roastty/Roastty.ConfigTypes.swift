// This file contains the configuration types for Roastty so that alternate targets
// can get typed information without depending on all the dependencies of RoasttyKit.
