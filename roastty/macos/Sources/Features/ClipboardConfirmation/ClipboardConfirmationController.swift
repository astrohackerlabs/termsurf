...
class ClipboardConfirmationController: NSWindowController {
    ...
    init(surface: roastty_surface_t, contents: String, request: Roastty.ClipboardRequest, state: UnsafeMutableRawPointer?, delegate: ClipboardConfirmationViewDelegate) {
