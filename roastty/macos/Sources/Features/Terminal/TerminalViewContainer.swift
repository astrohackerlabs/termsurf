...
class TerminalViewContainer: NSView {
    ...
    func roasttyConfigDidChange(_ config: Roastty.Config, preferredBackgroundColor: NSColor?) {
...
extension TerminalViewContainer {
    ...
    struct DerivedConfig: Equatable {
        ...
        init?(config: Roastty.Config, preferredBackgroundColor: NSColor?, cornerRadius: CGFloat?) {
