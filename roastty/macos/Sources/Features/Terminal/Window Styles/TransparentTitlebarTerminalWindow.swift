...
class TransparentTitlebarTerminalWindow: TerminalWindow {
    ...
    private var lastSurfaceConfig: Roastty.SurfaceView.DerivedConfig?
    ...
    override func syncAppearance(_ surfaceConfig: Roastty.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceTahoe(_ surfaceConfig: Roastty.SurfaceView.DerivedConfig) {
    ...
    private func syncAppearanceVentura(_ surfaceConfig: Roastty.SurfaceView.DerivedConfig) {
