...
class TerminalWindow: NSWindow {
    ...
    override func awakeFromNib() {
        ...
        // Get our saved level
        level = UserDefaults.roastty.value(forKey: Self.defaultLevelKey) as? NSWindow.Level ?? .normal
    }
    ...
    /// added.
    static let tabBarIdentifier: NSUserInterfaceItemIdentifier = .init("_roasttyTabBar")
    ...
    func syncAppearance(_ surfaceConfig: Roastty.SurfaceView.DerivedConfig) {
    ...
    var preferredBackgroundColor: NSColor? {
        if let terminalController, !terminalController.surfaceTree.isEmpty {
            let surface: Roastty.SurfaceView?
...
extension TerminalWindow {
    private static let closeTabsOnRightMenuItemIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.roastty.closeTabsOnTheRightMenuItem")
    private static let changeTitleMenuItemIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.roastty.changeTitleMenuItem")
    private static let tabColorSeparatorIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.roastty.tabColorSeparator")

    private static let tabColorPaletteIdentifier = NSUserInterfaceItemIdentifier("com.mitchellh.roastty.tabColorPalette")
