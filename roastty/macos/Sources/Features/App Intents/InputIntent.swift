...
struct KeyEventIntent: AppIntent {
    ...
    var action: Roastty.Input.Action
    ...
    func perform() async throws -> some IntentResult {
        ...
        // Convert KeyEventMods array to Roastty.Input.Mods
        let roasttyMods = mods.reduce(Roastty.Input.Mods()) { result, mod in
            result.union(mod.roasttyMod)
        }
...
struct MouseButtonIntent: AppIntent {
    ...
    var button: Roastty.Input.MouseButton
    ...
    var action: Roastty.Input.MouseState
    ...
    func perform() async throws -> some IntentResult {
        ...
        let mouseEvent = Roastty.Input.MouseButtonEvent(
            action: action,
            button: button,
            mods: roasttyMods
        )
...
struct MousePosIntent: AppIntent {
    ...
    func perform() async throws -> some IntentResult {
        ...
        let mousePosEvent = Roastty.Input.MousePosEvent(
            x: x,
            y: y,
            mods: roasttyMods
        )
...
struct MouseScrollIntent: AppIntent {
    ...
    @Parameter(
        ...
        default: Roastty.Input.Momentum.none
    )
    var momentum: Roastty.Input.Momentum
...
enum KeyEventMods: String, AppEnum, CaseIterable {
    ...
    var roasttyMod: Roastty.Input.Mods {
        switch self {
        case .shift: .shift
        case .control: .ctrl
        case .option: .alt
