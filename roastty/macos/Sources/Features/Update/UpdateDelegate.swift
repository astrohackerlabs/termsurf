...
extension UpdateDriver: SPUUpdaterDelegate {
    func feedURLString(for updater: SPUUpdater) -> String? {
        ...
        // do this instead.
        switch appDelegate.roastty.config.autoUpdateChannel {
        case .tip: return "https://tip.files.roastty.org/appcast.xml"
        case .stable: return "https://release.files.roastty.org/appcast.xml"
        }
    }
