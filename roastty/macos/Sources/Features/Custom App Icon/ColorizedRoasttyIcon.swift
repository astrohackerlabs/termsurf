...
struct ColorizedRoasttyIcon {
    ...
    let frame: Roastty.MacOSIconFrame

    /// Make a custom colorized roastty icon.
...
extension ColorizedRoasttyIcon: Codable {
    ...
    init(from decoder: any Decoder) throws {
        ...
        guard version == 0 || version == CodingKeys.currentVersion else {
            throw DecodingError.dataCorrupted(
                DecodingError.Context(
                    ...
                    debugDescription: "Unsupported ColorizedRoasttyIcon version: \(version)"
                )
            )
        }
        ...
        let frame = try container.decode(Roastty.MacOSIconFrame.self, forKey: .frame)
...
extension ColorizedRoasttyIcon: Equatable {
