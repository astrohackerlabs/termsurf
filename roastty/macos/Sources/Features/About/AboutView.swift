...
struct AboutView: View {
    ...
    private let githubURL = URL(string: "https://github.com/roastty-org/roastty")
    private let docsURL = URL(string: "https://roastty.org/docs")

    /// Read the commit from the bundle.
    private var build: String? { Bundle.main.infoDictionary?["CFBundleVersion"] as? String }
    private var commit: String? { Bundle.main.infoDictionary?["RoasttyCommit"] as? String }
    ...
    private enum VersionConfig {
        ...
        var url: URL? {
            ...
            case .stable(let version):
                ...
                return URL(string: "https://roastty.org/docs/install/release-notes/\(slug)")
            default:
                return nil
            }
        }
