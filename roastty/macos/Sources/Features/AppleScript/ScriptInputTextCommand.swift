...
/// Handler for the `input text` AppleScript command defined in `Roastty.sdef`.
///
/// Cocoa scripting instantiates this class because the command's `<cocoa>` element
/// specifies `class="RoasttyScriptInputTextCommand"`. The runtime calls
/// `performDefaultImplementation()` to execute the command.
@MainActor
@objc(RoasttyScriptInputTextCommand)
