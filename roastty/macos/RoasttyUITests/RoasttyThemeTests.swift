...
final class RoasttyThemeTests: RoasttyCustomConfigCase {
    override static var runsForEachTargetApplicationUIConfiguration: Bool {
        true
    }

    let windowTitle = "RoasttyThemeTests"
    ...
    /// https://github.com/roastty-org/roastty/issues/8282
    @MainActor
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of Roastty are very slow and you may experience performance problems. Debug builds are only recommended during development."
