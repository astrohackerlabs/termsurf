...
final class RoasttyMouseStateTests: RoasttyCustomConfigCase {
    // https://github.com/roastty-org/roastty/pull/11276
    @MainActor func testSelectionFocusChange() async throws {
        ...
        let tmpFile = NSTemporaryDirectory() + "roastty_test_dummy.txt"
