...
class MockConfig: Roastty.Config {
    internal init(backgroundBlur: Roastty.Config.BackgroundBlur, backgroundColor: Color, backgroundOpacity: Double) {
    ...
    var _backgroundBlur: Roastty.Config.BackgroundBlur
    var _backgroundColor: Color
    var _backgroundOpacity: Double

    override var backgroundBlur: Roastty.Config.BackgroundBlur {
        _backgroundBlur
    }
...
struct TerminalViewContainerTests {
    @Test func glassAvailability() async throws {
        ...
        await view.roasttyConfigDidChange(config, preferredBackgroundColor: nil)
    ...
    @Test func configChangeUpdatesGlass() async throws {
        ...
        await view.roasttyConfigDidChange(config1, preferredBackgroundColor: nil)
        ...
        await view.roasttyConfigDidChange(config1, preferredBackgroundColor: .red)
        ...
        // This won't change, unless roasttyConfigDidChange is called
        #expect(effectView.cornerRadius == 0)
        ...
        await view.roasttyConfigDidChange(config2, preferredBackgroundColor: .red)
