...
struct ConfigTests {
    ...
    @Test(arguments: [
        ("native", Roastty.Config.MacOSTitlebarStyle.native),
        ("transparent", Roastty.Config.MacOSTitlebarStyle.transparent),
        ("tabs", Roastty.Config.MacOSTitlebarStyle.tabs),
        ("hidden", Roastty.Config.MacOSTitlebarStyle.hidden),
    ])
    func macosTitlebarStyleValues(raw: String, expected: Roastty.Config.MacOSTitlebarStyle) throws {
    ...
    @Test(arguments: [
        ("always", Roastty.Config.ResizeOverlay.always),
        ("never", Roastty.Config.ResizeOverlay.never),
        ("after-first", Roastty.Config.ResizeOverlay.after_first),
    ])
    func resizeOverlayValues(raw: String, expected: Roastty.Config.ResizeOverlay) throws {
