...
GHOSTTY_API uintptr_t ghostty_config_get_repeatable_string_count(ghostty_config_t, const char*, uintptr_t);
GHOSTTY_API const char* ghostty_config_get_repeatable_string_value(ghostty_config_t, const char*, uintptr_t, uintptr_t);
