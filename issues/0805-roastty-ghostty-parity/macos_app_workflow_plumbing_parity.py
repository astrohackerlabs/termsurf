...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("native menu display/validation", "menu display gap"),
            ("titlebar/fullscreen/quick-terminal visuals", "visual gap"),
            ("screenshot/pixel evidence", "screenshot/pixel gap"),
            ("broader command-palette GUI behavior", "remaining command palette GUI gap"),
        ],
    )
    ...
    require_all(
        ...
        [
            ...
            ("69 rows Oracle complete", "command palette CFG-223 oracle count"),
            ("72 rows closed", "command palette CFG-223 closed count"),
        ],
    )
    require_all(
        ...
        [
            ...
            ("69 rows Oracle complete", "terminal residual CFG-223 oracle count"),
            ("72 rows closed", "terminal residual CFG-223 closed count"),
        ],
    )
    ...
    require_all(
        cfg223,
        [
            ("69 rows Oracle complete", "CFG-223 oracle count"),
            ("72 rows closed", "CFG-223 closed count"),
