...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("non-glass compositor opacity", "RUNTIME-008B2B2B2B compositor opacity gap"),
            ("screenshot-level padding pixel proof", "RUNTIME-008B2B2B2B screenshot screenshot padding gap"),
            ("GUI cursor pixels", "RUNTIME-008B2B2B2B GUI cursor gap"),
            ("custom shader output", "RUNTIME-008B2B2B2B custom shader gap"),
            ("broader GUI/pixel parity", "RUNTIME-008B2B2B2B GUI parity gap"),
        ],
    )
