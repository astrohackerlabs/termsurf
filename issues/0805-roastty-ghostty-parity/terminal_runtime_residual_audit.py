...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("RUNTIME-007B", "font gap remains tracked"),
            ("RUNTIME-008B2B", "renderer gap remains tracked"),
            ("RUNTIME-011", "macOS gap remains tracked"),
            ("RUNTIME-012B2B", "notification/link GUI gap remains tracked"),
        ],
    )
    ...
    require_all(
        ...
        [
            ...
            ("44 rows Oracle complete", "CFG-223 oracle count"),
            ("46 rows closed", "CFG-223 closed count"),
