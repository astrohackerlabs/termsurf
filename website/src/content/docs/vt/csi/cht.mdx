...
the terminal screen or the right margin, whichever is smaller.
This sequence does not change behavior with origin mode set.
...
horizontal tab set (HTS), [tab clear (TBC)](/docs/vt/csi/tbc), etc.
