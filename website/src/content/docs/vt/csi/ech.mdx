...
navLabel: ECH
description: Blank `n` cells beginning with and including the cursor through to the right of the cursor.
...
If Select Character Selection Attribute (DECSCA) is enabled
