...
navLabel: DCH
description: Delete `n` characters at the current cursor position and shift existing cell contents left.
...
region if it is left of the left margin, or right of the
right margin.
