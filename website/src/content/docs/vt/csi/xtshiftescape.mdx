...
navLabel: XTSHIFTESCAPE
description: Configure whether mouse reports are allowed to capture the `shift` modifier.
...
When a terminal program requests mouse reporting, some mouse
