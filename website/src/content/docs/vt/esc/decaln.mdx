...
navLabel: DECALN
description: Reset margins, move cursor to the top left, and fill the screen with `E`.
...
Reset the top, bottom, left, and right margins and unset origin mode.
...
The protected attribute is not unset.
