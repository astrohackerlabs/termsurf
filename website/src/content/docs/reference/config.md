...
<!-- GENERATED by scripts/gen-references.ts from the Ghostboard fork's ghostty.5.md. Do not edit by hand; run `bun run gen:references`. -->

# Configuration Options

Every configuration option, generated from the TermSurf Ghostboard fork's `ghostty.5.md`. See [Configuration](/docs/reference/configuration) for the config file location and the TermSurf-specific settings.
...
See [`font-variation`](#font-variation).
...
See [`adjust-cell-width`](#adjust-cell-width).
...
See [`selection-foreground`](#selection-foreground).
...
See [`search-foreground`](#search-foreground).
...
See [`search-selected-foreground`](#search-selected-foreground).
...
See [`window-height`](#window-height).
...
See [`window-position-x`](#window-position-x).
...
See [`clipboard-read`](#clipboard-read).
