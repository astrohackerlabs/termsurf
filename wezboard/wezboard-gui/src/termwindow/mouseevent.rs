...
use wezboard_dynamic::ToDynamic;
use wezboard_term::input::{MouseButton, MouseEventKind as TMEK};
use wezboard_term::{ClickPosition, LastMouseClick, StableRowIndex};
...
impl super::TermWindow {
    ...
    fn mouse_event_terminal(
        ...
        let mouse_event = wezboard_term::MouseEvent {
