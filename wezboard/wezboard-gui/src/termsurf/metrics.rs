...
pub fn set(
    ...
    BORDER_LEFT.store(border_left, Ordering::Relaxed);
    BORDER_TOP.store(border_top, Ordering::Relaxed);
}
...
pub fn get() -> (u32, u32, u32, u32, u32, u32) {
    (
        ...
        BORDER_LEFT.load(Ordering::Relaxed),
        BORDER_TOP.load(Ordering::Relaxed),
    )
}
