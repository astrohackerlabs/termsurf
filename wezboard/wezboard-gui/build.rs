fn main() {
    ...
    #[cfg(windows)]
    {
        ...
        // version number that we report in wezboard -h.
...
BEGIN
    ...
    BEGIN
        BLOCK "040904E4"
        BEGIN
            VALUE "CompanyName",      "Wez Longboard\0"
            VALUE "FileDescription",  "Wezboard - Wez's Terminal Emulator\0"
            VALUE "FileVersion",      "{version}\0"
            VALUE "LegalCopyright",   "Wez Longboard, MIT licensed\0"
            VALUE "InternalName",     "\0"
            VALUE "OriginalFilename", "\0"
            VALUE "ProductName",      "Wezboard\0"
